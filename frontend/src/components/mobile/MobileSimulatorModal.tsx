  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fadeIn">
      ...
      <div className="relative flex flex-col items-center max-w-4xl w-full max-h-[92vh]">
        ...
        {/* Smartphone Hardware Mockup Frame (Silver / Slate Edition) */}
          ...
          <div className="relative flex-1 bg-[#F8FAFC] rounded-[38px] overflow-hidden flex flex-col text-slate-800 select-none">
            ...
            <div className="px-5 py-2.5 bg-white border-b border-slate-200 flex justify-between items-center z-30 shadow-xs">
              ...
              <button 
                ...
                className="bg-amber-50 border border-rmyc-gold text-amber-900 px-2.5 py-1 rounded-full text-[9px] font-bold uppercase tracking-wider flex items-center gap-1 hover:bg-amber-100 transition-colors shadow-2xs"
              >
            ...
            <div className="flex-1 overflow-y-auto px-4 py-3 space-y-4 text-slate-800 text-xs custom-scrollbar">
              {activeTab === 'home' && (
                <div className="space-y-4 animate-fadeIn">
                  ...
                  {/* Weather Snapshot Grid (Light Theme) */}
                  <div>
                  ...
                  {/* Mobile Quick Actions (Light Theme) */}
            ...
            {/* Smartphone Bottom Navigation Bar (Light Theme) */}
